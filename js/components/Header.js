  ...
  template: `
    <header class="site-header">
      <div class="container site-header__inner">
        ...
        <a class="button-secondary site-header__cta" :href="whatsappLink" target="_blank" rel="noreferrer">
          Agendar
        </a>
        ...
        <nav id="main-navigation" class="header-nav" :class="{ 'is-open': isMenuOpen }" aria-label="Principal">
          ...
          <a class="button header-nav__cta" :href="whatsappLink" target="_blank" rel="noreferrer">
